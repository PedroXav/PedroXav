...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  <div style="text-align: left; margin-right: 50px;">
    <ul>
      <li>Sou estudante de Análise e Desenvolvimento de Sistemas do Instituto Federal de São Paulo - CBT 🦜</li>
      ...
      🚀 </li>
      <li>Estou em busca de uma oportunidade na área 💼</li>
...
<img align="left" src="src/3.png" alt="Tecnologias"/>
<table>
  <tr>
    <td>
